...
'<button id="profileBtn" style="position:absolute;left:78%;top:28%;width:18%;height:18%;background:rgba(255,0,0,.3);border:0;box-shadow:none;z-index:9999;cursor:pointer;"></button>' +
  '</div>' +
'</div>' +
