...
'#game{display:none}',
'#mainStart{position:absolute;left:50%;bottom:7%;width:260px;height:85px;transform:translateX(-50%);border:0;background:transparent;cursor:pointer;z-index:9999;touch-action:manipulation}',
