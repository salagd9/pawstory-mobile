...
'<div id="mainProfileName" style="position:absolute;left:78.2%;top:37.2%;width:18%;height:2.2%;background:#1687ed;border-radius:5px;display:flex;align-items:center;justify-content:center;text-align:center;color:white;font-size:11px;font-weight:bold;z-index:21;"></div>' +
 '<div id="mainProfileRecord" style="position:absolute;left:85%;top:39.8%;width:10%;height:2%;background:#fff;display:flex;align-items:center;justify-content:center;color:#222;font-size:10px;font-weight:bold;z-index:21;">0승 0패</div>' +
...
document.getElementById('mainProfileName').textContent = savedName;
}
